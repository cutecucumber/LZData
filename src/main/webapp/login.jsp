...
<body>
	<div class='login'>
	  ...
	  <p style = "font-size: 16px;margin-top: -20px;margin-bottom: 40px;text-align: center">欢迎进入登录界面</p>
	  <div class='login_fields'>
	    ...
	    <div class='login_fields__submit'>
	      <p><input type='button' value='登录' style = "margin-left: 66px;margin-top: 10px;margin-bottom: 30px"></p>
	      <a href = "newzhuce.jsp" >还没注册账号！</a>
	    </div>
	  ...
	  <div class='disclaimer'>
	    ...
	    <p style = "text-align: center;color: green">欢迎登录网络安全教学平台</p>
	  </div>
	</div>
	<div class='authent'>
	    ...
	    layui.use('layer', function () {
	        ...
	        $('input[type="button"]').click(function () {
	            ...
	            if (login == '') {
					...
					//此处做为ajax内部判断
					var url = "";
					$.post("<%=request.getContextPath()%>/login",JsonData,function(data){
